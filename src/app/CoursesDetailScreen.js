...
export default function CoursesDetailScreen({ navigation, route }) {
  ...
  return (
    <View style={styles.container}>
      <BackButton navigation={navigation} extraStyles={styles.backButton} />
      <Image source={course.img} style={styles.courseImage} />
      <View style={styles.courseDetailsContainer}>
        <View style={styles.courseDescriptionContainer}>
          <Text style={styles.courseDescriptionText}>دەربارەی وانەکە</Text>
